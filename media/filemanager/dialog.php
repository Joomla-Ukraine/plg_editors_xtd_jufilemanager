...
<head>
    ...
    <noscript>
        <link rel="stylesheet" href="style/jquery.fileupload-noscript.css">
    </noscript>
    <noscript>
        <link rel="stylesheet" href="style/jquery.fileupload-ui-noscript.css">
    </noscript>
    ...
    <link id="dark-mode-css" rel="stylesheet" href="style/style.dark.css"
          <?php if (!$dark_mode_active): ?>disabled<?php endif; ?>>
...
<input type="hidden" id="current_url" value="<?php echo htmlspecialchars(
    str_replace(array('&filter='.$filter, '&sort_by='.$sort_by, '&descending='.intval($descending)),
        array(''),
...
<input type="hidden" id="delete_files_allowed" value="<?php if ($config['delete_files']) {
    echo 1;
} else {
    echo 0;
} ?>"/>
...
<input type="hidden" id="clipboard" value="<?php echo((isset($_SESSION['RF']['clipboard']['path']) && trim(
    ...
    <div class="uploader">
        <div class="flex">
            <div class="text-center">
                <button class="btn btn-inverse close-uploader"><img class="svg-icon svg-icon-white"
                                                                    src="svg/icon-back.svg" alt=""> <?php echo trans(
                        'Return_Files_List'
                    ) ?></button>
            ...
            <div class="tabbable upload-tabbable"> <!-- Only required for left/right tabs -->
                <div class="container1">
                    <ul class="nav nav-tabs">
                        <li class="active"><a href="#baseUpload" data-toggle="tab"><?php echo trans(
                                    'Upload_base'
                                ); ?></a></li>
                            ...
                            <div class="tab-pane" id="urlUpload">
                                ...
                                <form class="form-horizontal">
                                    <div class="control-group">
                                        <label class="control-label" for="url"><?php echo trans(
                                                'Upload_url'
                                            ); ?></label>
                                        <div class="controls">
                                    ...
                                    <div class="control-group">
                                        <div class="controls">
                                            <button class="btn btn-primary" id="uploadURL"><?php echo trans(
                                                    'Upload_file'
                                                ); ?></button>
                                        </div>
                                    </div>
...
<div class="container-fluid">
                    ...
                    <div class="filters">
                        <div class="row-fluid">
                            <div class="span4 half">
                                <?php if ($config['upload_files']) { ?>
                                    <button class="tip btn upload-btn" title="<?php echo trans('Upload_file'); ?>"><img
                                                class="svg-icon" src="svg/icon-upload.svg" alt=""> <?php echo trans(
                                            'Upload_file'
                                        ); ?></button>
                                <?php } ?>
                                <?php if ($config['create_text_files']) { ?>
                                    <button class="tip btn create-file-btn" title="<?php echo trans('New_File'); ?>">
                                        <img class="svg-icon" src="svg/icon-plus.svg" alt=""><img class="svg-icon"
                                ...
                                <?php if ($config['create_folders']) { ?>
                                    <button class="tip btn new-folder" title="<?php echo trans('New_Folder') ?>"><img
                                                class="svg-icon" src="svg/icon-plus.svg" alt=""><img class="svg-icon"
                                                                                                     src="svg/icon-folder.svg"
                                                                                                     alt=""> <?php echo trans(
                                            'New_Folder'
                                        ); ?></button>
                                <?php } ?>
                                <?php if ($config['copy_cut_files'] || $config['copy_cut_dirs']) { ?>
                                    <button class="tip btn paste-here-btn" title="<?php echo trans('Paste_Here'); ?>">
                                        <img class="svg-icon" src="svg/icon-paste.svg" alt=""></button>
                                    <button class="tip btn clear-clipboard-btn"
                                            title="<?php echo trans('Clear_Clipboard'); ?>"><img class="svg-icon"
                                    ...
                                    <?php if ($config['multiple_selection']) { ?>
                                        <?php if ($config['delete_files']) { ?>
                                            <button class="tip btn multiple-delete-btn"
                                                    ...
                                                    data-confirm="<?php echo trans('Confirm_del'); ?>"><img
                                                        class="svg-icon" src="svg/icon-trash.svg" alt=""></button>
                                        <?php } ?>
                                        <button class="tip btn multiple-select-btn"
                                                title="<?php echo trans('Select_All'); ?>"><img class="svg-icon"
                                                                                                src="svg/icon-check.svg"
                                                                                                alt=""></button>
                                        <button class="tip btn multiple-deselect-btn"
                                                title="<?php echo trans('Deselect_All'); ?>"><img class="svg-icon"
                                                                                                  src="svg/icon-ban.svg"
                                                                                                  alt=""></button>
                                        <?php if ($apply_type != "apply_none" && $config['multiple_selection_action_button']) { ?>
                                            <button class="btn multiple-action-btn btn-inverse"
                                                    data-function="<?php echo $apply_type; ?>"><?php echo trans(
                                                    'Select'
                                                ); ?></button>
                                        <?php } ?>
                                    <?php } ?>
                            ...
                            <div class="span2 half view-controller">
                                <button class="btn tip<?php if ($view == 0) {
                                    echo " btn-inverse";
                                } ?>" id="view0" data-value="0" title="<?php echo trans('View_boxes'); ?>"><img
                                            class="svg-icon<?php if ($view == 0) {
                                                echo " svg-icon-white";
                                            } ?>" src="svg/icon-grid.svg" alt=""></button>
                                <button class="btn tip<?php if ($view == 1) {
                                    echo " btn-inverse";
                                } ?>" id="view1" data-value="1" title="<?php echo trans('View_list'); ?>"><img
                                            class="svg-icon<?php if ($view == 1) {
                                                echo " svg-icon-white";
                                            } ?>" src="svg/icon-list.svg" alt=""></button>
                                <button class="btn tip<?php if ($view == 2) {
                                    echo " btn-inverse";
                                } ?>" id="view2" data-value="2" title="<?php echo trans('View_columns_list'); ?>"><img
                                            class="svg-icon<?php if ($view == 2) {
                                                echo " svg-icon-white";
                                            } ?>" src="svg/icon-columns.svg" alt=""></button>
                            </div>
                            <div class="span6 entire types">
                                ...
                                <?php if ($_GET['type'] != 1 && $_GET['type'] != 3 && $config['show_filter_buttons']) { ?>
                                    <?php if (count($config['ext_file']) > 0 or false) { ?>
                                        ...
                                        <label id="ff-item-type-1" title="<?php echo trans('Files'); ?>"
                                               for="select-type-1" class="tip btn ff-label-type-1"><img class="svg-icon"
                                                                                                        src="svg/icon-file.svg"
                                                                                                        alt=""></label>
                                    <?php } ?>
                                    <?php if (count($config['ext_img']) > 0 or false) { ?>
                                        ...
                                        <label id="ff-item-type-2" title="<?php echo trans('Images'); ?>"
                                               for="select-type-2" class="tip btn ff-label-type-2"><img class="svg-icon"
                                    ...
                                    <?php if (count($config['ext_misc']) > 0 or false) { ?>
                                        ...
                                        <label id="ff-item-type-3" title="<?php echo trans('Archives'); ?>"
                                               for="select-type-3" class="tip btn ff-label-type-3"><img class="svg-icon"
                                                                                                        src="svg/icon-archive.svg"
                                                                                                        alt=""></label>
                                    <?php } ?>
                                    <?php if (count($config['ext_video']) > 0 or false) { ?>
                                        ...
                                        <label id="ff-item-type-4" title="<?php echo trans('Videos'); ?>"
                                               for="select-type-4" class="tip btn ff-label-type-4"><img class="svg-icon"
                                                                                                        src="svg/icon-film.svg"
                                                                                                        alt=""></label>
                                    <?php } ?>
                                    <?php if (count($config['ext_music']) > 0 or false) { ?>
                                        ...
                                        <label id="ff-item-type-5" title="<?php echo trans('Music'); ?>"
                                               for="select-type-5" class="tip btn ff-label-type-5"><img class="svg-icon"
                                                                                                        src="svg/icon-music.svg"
                                                                                                        alt=""></label>
                                    <?php } ?>
                                <?php } ?>
                                ...
                                <?php if (!empty($config['remove_header'])): ?>
                                    <button type="button" class="btn btn-danger pull-right close-dialog-btn"
                                            title="<?php echo trans('Close'); ?>"><img class="svg-icon svg-icon-white"
                                                                                       src="svg/icon-close.svg" alt="">
                                    </button>
                                <?php endif; ?>
                                <button type="button" id="dark-mode-toggle" class="btn pull-right tip"
                                        title="Dark / Light mode" style="margin-left:4px; margin-right:4px">
                                    <img id="dm-icon-moon" class="svg-icon" src="svg/icon-moon.svg" alt=""
                                         <?php if ($dark_mode_active): ?>style="display:none"<?php endif; ?>>
                                    <img id="dm-icon-sun" class="svg-icon" src="svg/icon-light.svg" alt=""
                                         <?php if (!$dark_mode_active): ?>style="display:none"<?php endif; ?>>
                                </button>
                            </div>
                        </div>
    ...
    <div class="row-fluid">
        ...
        ?>
        <ul class="breadcrumb">
            <li class="pull-left"><a href="<?php echo $link ?>/"><img class="svg-icon" src="svg/icon-home.svg"
                                                                      alt=""></a></li>
            ...
            <?php if ($config['show_language_selection']) { ?>
                <li class="pull-right"><a class="btn-small" href="javascript:void('')" id="change_lang_btn"><img
                                class="svg-icon" src="svg/icon-globe.svg" alt=""></a></li>
            <?php } ?>
            <li class="pull-right"><a id="refresh" class="btn-small"
                                      href="dialog.php?<?php echo $get_params.$subdir."&".uniqid() ?>"><img
                            class="svg-icon" src="svg/icon-refresh.svg" alt=""></a></li>
            ...
            <li><small class="hidden-phone">(<span id="files_number"><?php echo $current_files_number."</span> ".trans(
                                'Files'
            ...
            <?php if ($config['show_total_size']) { ?>
                <li><small class="hidden-phone"><span
                                title="<?php echo trans('total size').$config['MaxSizeTotal']; ?>"><?php echo trans(
                                    'total size'
                                ).": ".makeSize($sizeCurrentFolder).(($config['MaxSizeTotal'] !== false && is_int(
                                        $config['MaxSizeTotal']
    ...
    <div class="row-fluid ff-container">
        <div class="span12">
            <?php if( !is_dir($config['current_path'].$rfm_subfolder.$subdir) || opendir(
            ...
            <ul class="grid cs-style-2 <?php echo "list-view".$view; ?>" id="main-item-container">
                ...
                foreach ($files as $file_array) {
                    ...
                    <li data-name="<?php echo $file ?>" class="<?php if ($file == '..') {
                        ...
                        echo 'dir';
                    } ?> <?php if (!$config['multiple_selection']) { ?>no-selector<?php } ?>" <?php if (($filter != '' && stripos(
                            $file,
                            $filter
                        ) === false)) {
                        ...
                        <figure data-name="<?php echo $file ?>" data-path="<?php echo $rfm_subfolder.$subdir.$file; ?>"
                            ...
                            <?php } ?>
                            <a class="folder-link" href="dialog.php?<?php echo $get_params.rawurlencode(
                                    $src
                                )."&".($callback ? 'callback='.$callback."&" : '').uniqid() ?>">
                                <div class="img-precontainer">
                                    <div class="img-container directory"><span></span>
                                        <img class="directory-img" data-src="svg/folder<?php if ($file == "..") {
                                            echo "_back";
                                        } ?>.svg"/>
                                    </div>
                                </div>
                        ...
                        <?php } else { ?>
                            ...
                            <figcaption>
                                ...
                                <a href="javascript:void('')"
                                   class="tip-left erase-button <?php if ($config['delete_folders'] && !$file_prevent_delete) {
                                       echo "delete-folder";
                                   } else {
                                       echo "disabled";
                                   } ?>" title="<?php echo trans('Erase') ?>"
                    ...
                    <figure data-name="<?php echo $file ?>" data-path="<?php echo $rfm_subfolder.$subdir.$file; ?>"
                        ...
                        <a href="javascript:void('')" class="link" data-file="<?php echo $file; ?>"
                           data-function="<?php echo $apply; ?>">
                            ...
                            <div class="img-precontainer-mini <?php if ($is_img) echo 'original-thumb' ?>">
                                <?php if ($config['multiple_selection']) { ?>
                                <?php } ?>
                                <div class="filetype <?php echo $file_array['extension'] ?> <?php if (in_array(
                                    $file_array['extension'],
                        ...
                        <figcaption>
                            <form action="force_download.php" method="post" class="download-form"
                                ...
                                <a title="<?php echo trans('Download') ?>"
                                   class="tip-right <?php if (!$config['download_files']) {
                                       echo 'disabled';
                                   } ?>"
                                   href="javascript:void('')" <?php if ($config['download_files']) echo "onclick=\"$('#form".$nu."').submit();\"" ?>><img
                                            src="svg/icon-download.svg" alt="Download" class="svg-icon"></a>

                                <?php if ($is_img) { ?>
                                    <a class="tip-right preview" title="<?php echo trans('Preview') ?>"
                                       data-featherlight="<?php echo $src; ?>" href="#"><img src="svg/icon-eye.svg"
                                                                                             alt="Preview"
                                                                                             class="svg-icon"></a>
                                    <?php if (!empty($config['tui_active']) && in_array(
                                            $file_array['extension'],
                                            array('jpg', 'jpeg', 'png', 'webp')
                                        )) { ?>
                                        <a class="tip-right launch-tui-editor" title="<?php echo trans('Edit_image') ?>"
                                           href="javascript:void('')" data-path="<?php echo $src; ?>"
                                           data-name="<?php echo $file; ?>"><img src="svg/icon-edit.svg" alt="Edit"
                                                                                 class="svg-icon"></a>
                                    <?php } ?>
                                <?php } elseif (($is_video || $is_audio) && in_array(
                                        $file_array['extension'],
                                        $config['jplayer_exts']
                                    )) { ?>
                                    <a class="tip-right modalAV <?php if ($is_audio) {
                                       ...
                                       href="javascript:void('');"><img src="svg/icon-eye.svg" alt="Preview"
                                                                        class="svg-icon"></a>
                                <?php } elseif (in_array($file_array['extension'], $config['cad_exts'])) { ?>
                                    <a class="tip-right file-preview-btn" title="<?php echo trans('Preview') ?>"
                                       ...
                                       href="javascript:void('');"><img src="svg/icon-eye.svg" alt="Preview"
                                                                        class="svg-icon"></a>
                                <?php } elseif ($config['preview_text_files'] && in_array(
                                        $file_array['extension'],
                                    ...
                                    <a class="tip-right file-preview-btn" title="<?php echo trans('Preview') ?>"
                                       ...
                                       href="javascript:void('');"><img src="svg/icon-eye.svg" alt="Preview"
                                                                        class="svg-icon"></a>
                                <?php } elseif ($config['googledoc_enabled'] && in_array(
                                        $file_array['extension'],
                                    ...
                                    <a class="tip-right file-preview-btn" title="<?php echo trans('Preview') ?>"
                                       ...
                                       href="docs.google.com;"><img src="svg/icon-eye.svg" alt="Preview"
                                                                    class="svg-icon"></a>
                                <?php } else { ?>
                                    <a class="preview disabled"><img src="svg/icon-eye.svg" alt="Preview"
                                                                     class="svg-icon"></a>
                                <?php } ?>
                                <a href="javascript:void('')"
                                ...
                                <a href="javascript:void('')"
                                   class="tip-left erase-button <?php if ($config['delete_files'] && !$file_prevent_delete) {
                                       echo "delete-file";
                                   } else {
                                       echo "disabled";
                                   } ?>" title="<?php echo trans('Erase') ?>"
...
<?php if (!empty($config['tui_active'])): ?>
    ...
    <div id="tui-image-editor-wrapper"
         style="display:none;position:fixed;top:0;left:0;right:0;bottom:0;z-index:9999;background:#1e1e1e;flex-direction:column;">
        <div id="tui-editor-toolbar"
             style="height:50px;background:#2d2d2d;display:flex;justify-content:flex-end;align-items:center;gap:10px;padding:0 15px;border-bottom:1px solid #444;flex-shrink:0;">
            <button type="button" id="tui-save-btn" title="<?php echo trans('Image_Editor_Save'); ?>"
                    style="width:40px;height:40px;border:none;border-radius:4px;background:#28a745;cursor:pointer;display:flex;align-items:center;justify-content:center;">
            ...
            <button type="button" id="tui-close-btn" title="<?php echo trans('Image_Editor_Exit'); ?>"
                    style="width:40px;height:40px;border:none;border-radius:4px;background:#6c757d;cursor:pointer;display:flex;align-items:center;justify-content:center;">
                <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none"
                     stroke="#fff" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
